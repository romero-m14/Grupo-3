...
export default function Header() {
    ...
    return (
        <header className="relative flex flex-col gap-4 justify-between bg-navbar text-fondo 
                           p-6">
            ...
            <button onClick={() => setShow(!show)} 
                    className="cursor-pointer absolute top-8 right-6 md:hidden flex flex-col gap-2"
            >
